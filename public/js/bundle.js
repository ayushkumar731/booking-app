...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"forgotSetting.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.forgotSettings = void 0;
...
var forgotSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type, message, method, token) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = type === 'forgot' ? '/api/v1/users/forgotPassword' : "".concat(token);
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(message));
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
  ...
  return function forgotSettings(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();

exports.forgotSettings = forgotSettings;
...
var stripe = Stripe('pk_test_51HMAEaF6f2k3BgYkviDNTUTJU9fWcx0TLSV3Vww8oaZkpfvrZp2e5583bE8FRFAqwVEkrhMZ0H51rlIm4bT8MvOg00ajNEIYm7');
...
var _forgotSetting = require("./forgotSetting");
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              email = document.getElementById('email').value;
              _context4.next = 5;
              return (0, _forgotSetting.forgotSettings)({
                email: email
              }, 'forgot', 'Check Your Email', 'POST');
          ...
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              return (0, _forgotSetting.forgotSettings)({
                password: password,
                passwordConfirm: passwordConfirm
              }, 'reset', 'Updated Successfully', 'PATCH', token);
